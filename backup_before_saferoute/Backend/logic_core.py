...
class CityWatchEngine:
    ...
    TOOTHBRUSH_CLASS = 79  # 'toothbrush' - often detected
    
    # Additional classes for demo (easier to detect)
    CELL_PHONE_CLASS = 67  # 'cell phone' - easy to hold up
    BOTTLE_CLASS = 39      # 'bottle' 
    FORK_CLASS = 42        # 'fork'
    REMOTE_CLASS = 65      # 'remote' - common indoor object
    
    WEAPON_CLASSES = {KNIFE_CLASS, SCISSORS_CLASS, TOOTHBRUSH_CLASS, CELL_PHONE_CLASS, BOTTLE_CLASS, FORK_CLASS, REMOTE_CLASS}
